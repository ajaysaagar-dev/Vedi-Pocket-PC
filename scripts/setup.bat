...
echo ========================================================
echo           Vedi Pocket PC - Master Setup (Python)
echo ========================================================
echo.
...
:: Check Node.js (needed for Expo mobile bundler)
where node >nul 2>&1
if %ERRORLEVEL% NEQ 0 (
...
echo.
echo ========================================================
echo [1/3] Installing shared packages\core (editable) ...
echo ========================================================
python -m pip install -e packages\core
if %ERRORLEVEL% NEQ 0 (
    echo [WARNING] packages\core editable install returned non-zero.
)

echo.
echo ========================================================
echo [2/3] Installing Python Dependencies (Requirements)...
echo ========================================================
...
if /i "%LAUNCH%"=="Y" (
    echo.
    echo Starting Vedi Pocket PC Controller...
    python -m apps.desktop.controller.app
) else (
    echo.
    echo You can start the app anytime by double-clicking 'start.bat' or running 'python -m apps.desktop.controller.app'.
)
